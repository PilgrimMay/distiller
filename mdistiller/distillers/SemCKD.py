...
class SemCKD(Distiller):
    ...
    def __init__(self, student, teacher, cfg):
        ...
        self.stu_channels = self.student.get_stage_channels()[:]
        self.tea_channels = self.teacher.get_stage_channels()[:]
        self.attention_allocation = Attention_Allocation(self.num_stu_layer, self.num_tea_layer, self.batch_size,
    ...
    def forward_train(self, image, target, **kwargs):
        ...
        # print("batch size:", feature_student[0].shape)
        ...
        stu_channel = [f.shape[1] for f in feature_student[:]]
        tea_channel = [f.shape[1] for f in feature_teacher[:]]
        ...
        # print("batch size:", feature_student[0].shape)
        attention, proj_value_stu, value_tea = self.attention_allocation(feature_student[:], feature_teacher[:])
...
class Attention_Allocation(nn.Module):
    ...
    def forward(self, feat_s, feat_t):
        ...
        # print("self input_channels:", self.input_channel)
        # bs = self.input_channel
        bs = feat_s[0].shape[0]
