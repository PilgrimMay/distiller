...
CFG.SOLVER.EPOCHS = 40
# CFG.SOLVER.LR = 0.05
# CFG.SOLVER.LR_DECAY_STAGES = [150, 180, 210]
CFG.SOLVER.LR = 0.1
CFG.SOLVER.LR_DECAY_STAGES = [10, 20, 30]
...
# PKD CFG
CFG.PKD = CN()
CFG.PKD.TEMPERATURE = 4
# CFG.PKD.UPDATE = 'mean'
CFG.PKD.LOSS = CN()
CFG.PKD.LOSS.CE_WEIGHT = 1
CFG.PKD.LOSS.KD_WEIGHT = 1
CFG.PKD.LOSS.PROTOTYPE_WEIGHT = 1
CFG.PKD.LOSS_FUNC = 'l1'

# TaT CFG
CFG.TAT = CN()
CFG.TAT.TEMPERATURE = 4
CFG.TAT.PATCH_N = 2
CFG.TAT.PATCH_M = 2
CFG.TAT.GROUP = 2
CFG.TAT.LOSS = CN()
CFG.TAT.LOSS.CE_WEIGHT = 6
CFG.TAT.LOSS.KD_WEIGHT = 1
CFG.TAT.LOSS.TAT_WEIGHT = 39


# MultiStudent CFG
CFG.MS = CN()
CFG.MS.TEMPERATURE = 4
CFG.MS.LOSS = CN()
CFG.MS.LOSS.CE_WEIGHT = 0.1
CFG.MS.LOSS.KD_WEIGHT = 0.9
CFG.MS.LOSS.MUTUAL_WEIGHT = 0.2
...
# SemCKD CFG
CFG.SemCKD = CN()
CFG.SemCKD.TEMPERATURE = 4
CFG.SemCKD.LOSS = CN()
CFG.SemCKD.LOSS.CE_WEIGHT = 1
CFG.SemCKD.LOSS.KD_WEIGHT = 1
CFG.SemCKD.LOSS.FMD_WEIGHT = 400
